...
class DataProcessor:
    ...
    def run(self) -> List[CombinedMetric]:
        ...
        1. Collects energy and cost data.
        2. Calculates carbon emissions from energy data.
        ...
        carbon_data = self.calculator.calculate_carbon_emissions(energy_data)

        # Combine data into a dictionary for easy lookup by pod_name
        ...
        # Create a unified list of combined metrics
        ...
        for pod_name in sorted(list(all_pod_names)):
            # Find the original namespace from either dataset
