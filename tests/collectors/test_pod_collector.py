...
@pytest.mark.asyncio
@patch("greenkube.collectors.pod_collector.config.load_incluster_config")
@patch("greenkube.collectors.pod_collector.config.load_kube_config")
@patch("greenkube.collectors.pod_collector.client.CoreV1Api")
async def test_pod_collector_success(mock_core_v1_api, mock_load_kube, mock_load_incluster, mock_k8s_api):
...
@patch("greenkube.collectors.pod_collector.config.load_kube_config")
@patch("greenkube.collectors.pod_collector.client.CoreV1Api")
async def test_pod_collector_api_error(mock_core_v1_api, mock_load_kube, mock_load_incluster, mock_k8s_api):
