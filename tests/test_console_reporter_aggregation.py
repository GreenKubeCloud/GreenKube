...
def test_aggregation_without_period_sums_values():
    ...
    items = [
        CombinedMetric(pod_name='pod-a', namespace='ns1', total_cost=1.0, co2e_grams=10.0, joules=100.0, pue=1.2, grid_intensity=200.0, cpu_request=100, memory_request=1024),
        CombinedMetric(pod_name='pod-a', namespace='ns1', total_cost=2.0, co2e_grams=20.0, joules=200.0, pue=1.2, grid_intensity=200.0, cpu_request=100, memory_request=1024),
    ]
...
def test_aggregation_with_period_groups_by_period():
    ...
    items = [
        CombinedMetric(pod_name='pod-b', namespace='ns2', period='2025-01', total_cost=1.0, co2e_grams=5.0, joules=50.0, pue=1.1, grid_intensity=150.0, cpu_request=200, memory_request=2048),
        CombinedMetric(pod_name='pod-b', namespace='ns2', period='2025-02', total_cost=2.0, co2e_grams=10.0, joules=100.0, pue=1.1, grid_intensity=150.0, cpu_request=200, memory_request=2048),
    ]
